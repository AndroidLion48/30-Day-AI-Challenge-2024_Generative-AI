...
### 📝 Challenge Summary
Practice asking sharper questions and running self‑critiques. Build checklists that catch logic gaps, bias, and missing evidence.
...
### 🛠 Tools Used
- ChatGPT / Claude (critiques)
- Notion AI (review checklists)

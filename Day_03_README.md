...
### 📝 Challenge Summary
Use AI to decode memes and Gen‑Z/Alpha slang. Get meanings, origins, and usage examples so you don’t misread the culture or use terms out of pocket.
...
### 🛠 Tools Used
- ChatGPT (explain memes & slang)
- Perplexity (context + sources)
- KnowYourMeme (reference)
